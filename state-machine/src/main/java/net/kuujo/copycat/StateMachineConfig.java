 ...
 */
public class StateMachineConfig implements Copyable<StateMachineConfig> {
   ...
   */
  public StateMachineConfig withRequireCommandQuorum(boolean require) {
   ...
   * @throws IllegalArgumentException if {@code quorumSize} is not > -1
   */
  public StateMachineConfig withCommandQuorumSize(int quorumSize) {
   ...
   * @throws NullPointerException if {@code strategy} is null
   */
  public StateMachineConfig withCommandQuorumStrategy(QuorumStrategy strategy) {
   ...
   * @return The Copycat configuration.
   */
  public StateMachineConfig withConsistentCommandExecution(boolean consistent) {
   ...
   */
  public StateMachineConfig withRequireQueryQuorum(boolean require) {
   ...
   * @throws IllegalArgumentException if {@code quorumSize} is not > -1
   */
  public StateMachineConfig withQueryQuorumSize(int quorumSize) {
   ...
   * @throws NullPointerException if {@code strategy} is null
   */
  public StateMachineConfig withQueryQuorumStrategy(QuorumStrategy strategy) {
   ...
   * @return The Copycat configuration.
   */
  public StateMachineConfig withConsistentQueryExecution(boolean consistent) {
