 ...
 * {@link net.kuujo.copycat.Command commands} and {@link net.kuujo.copycat.Query queries} to the user provided
 ...
 * {@link #timestamp()} at which it was written, and the {@link net.kuujo.copycat.Session} that submitted the
 * operation.
 *
...
public class Commit<T extends Operation> {
   ...
   * <p>
   * This is the index at which the committed {@link net.kuujo.copycat.Operation} was written in the Raft log.
   * Copycat guarantees that this index will be the same for all instances of the given operation on all nodes in the
   * cluster.
   * <p>
   * Note that for {@link net.kuujo.copycat.Query} operations, the returned {@code index} may actually represent
   ...
   * <p>
   * The returned {@link net.kuujo.copycat.Session} is representative of the session that submitted the operation
   ...
   * <p>
   * Additionally, because clients only connect to one server at any given time, the {@link net.kuujo.copycat.Session}
   ...
   * <p>
   * The returned {@link net.kuujo.copycat.Operation} is the operation submitted by the user via
   * {@link net.kuujo.copycat.Raft#submit(net.kuujo.copycat.Operation)}.
   *
