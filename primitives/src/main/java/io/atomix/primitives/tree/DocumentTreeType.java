...
import io.atomix.primitives.tree.impl.DiscreteDocumentTreeBuilder;
import io.atomix.primitives.tree.impl.DocumentTreeService;
import io.atomix.primitives.tree.impl.PartitionedDocumentTreeBuilder;

/**
 * Document tree primitive type.
 */
public class DocumentTreeType<V> implements PrimitiveType<DocumentTreeBuilder<V>, DocumentTree<V>, AsyncDocumentTree<V>> {
  ...
  @Override
  public DocumentTreeBuilder<V> newPrimitiveBuilder(String name, PrimitiveClient client) {
    return new DiscreteDocumentTreeBuilder<>(name, client);
  }

  @Override
  public DocumentTreeBuilder<V> newPrimitiveBuilder(String name, PartitionService partitions) {
    return new PartitionedDocumentTreeBuilder<>(name, partitions);
  }
}
