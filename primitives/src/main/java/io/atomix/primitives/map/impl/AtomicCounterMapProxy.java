...
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.AddAndGet;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.DecrementAndGet;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.Get;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.GetAndAdd;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.GetAndDecrement;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.GetAndIncrement;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.IncrementAndGet;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.Put;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.PutIfAbsent;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.Remove;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.RemoveValue;
import io.atomix.primitives.map.impl.AtomicCounterMapOperations.Replace;
...
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.ADD_AND_GET;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.CLEAR;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.DECREMENT_AND_GET;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.GET;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.GET_AND_ADD;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.GET_AND_DECREMENT;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.GET_AND_INCREMENT;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.INCREMENT_AND_GET;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.IS_EMPTY;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.PUT;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.PUT_IF_ABSENT;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.REMOVE;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.REMOVE_VALUE;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.REPLACE;
import static io.atomix.primitives.map.impl.AtomicCounterMapOperations.SIZE;
