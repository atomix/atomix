...
import io.atomix.primitives.map.impl.ConsistentMapOperations.ContainsKey;
import io.atomix.primitives.map.impl.ConsistentMapOperations.ContainsValue;
import io.atomix.primitives.map.impl.ConsistentMapOperations.Get;
import io.atomix.primitives.map.impl.ConsistentMapOperations.GetOrDefault;
import io.atomix.primitives.map.impl.ConsistentMapOperations.Put;
import io.atomix.primitives.map.impl.ConsistentMapOperations.Remove;
import io.atomix.primitives.map.impl.ConsistentMapOperations.RemoveValue;
import io.atomix.primitives.map.impl.ConsistentMapOperations.RemoveVersion;
import io.atomix.primitives.map.impl.ConsistentMapOperations.Replace;
import io.atomix.primitives.map.impl.ConsistentMapOperations.ReplaceValue;
import io.atomix.primitives.map.impl.ConsistentMapOperations.ReplaceVersion;
import io.atomix.primitives.map.impl.ConsistentMapOperations.TransactionBegin;
import io.atomix.primitives.map.impl.ConsistentMapOperations.TransactionCommit;
import io.atomix.primitives.map.impl.ConsistentMapOperations.TransactionPrepare;
import io.atomix.primitives.map.impl.ConsistentMapOperations.TransactionPrepareAndCommit;
import io.atomix.primitives.map.impl.ConsistentMapOperations.TransactionRollback;
import io.atomix.primitives.transaction.TransactionId;
import io.atomix.primitives.transaction.TransactionLog;
...
import static io.atomix.primitives.map.impl.ConsistentMapEvents.CHANGE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.ADD_LISTENER;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.BEGIN;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.CLEAR;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.COMMIT;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.CONTAINS_KEY;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.CONTAINS_VALUE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.ENTRY_SET;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.GET;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.GET_OR_DEFAULT;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.IS_EMPTY;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.KEY_SET;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.PREPARE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.PREPARE_AND_COMMIT;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.PUT;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.PUT_AND_GET;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.PUT_IF_ABSENT;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REMOVE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REMOVE_LISTENER;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REMOVE_VALUE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REMOVE_VERSION;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REPLACE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REPLACE_VALUE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.REPLACE_VERSION;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.ROLLBACK;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.SIZE;
import static io.atomix.primitives.map.impl.ConsistentMapOperations.VALUES;
