...
import io.atomix.primitives.value.impl.AtomicValueOperations.CompareAndSet;
import io.atomix.primitives.value.impl.AtomicValueOperations.GetAndSet;
import io.atomix.primitives.value.impl.AtomicValueOperations.Set;
...
import static io.atomix.primitives.value.impl.AtomicValueEvents.CHANGE;
import static io.atomix.primitives.value.impl.AtomicValueOperations.ADD_LISTENER;
import static io.atomix.primitives.value.impl.AtomicValueOperations.COMPARE_AND_SET;
import static io.atomix.primitives.value.impl.AtomicValueOperations.GET;
import static io.atomix.primitives.value.impl.AtomicValueOperations.GET_AND_SET;
import static io.atomix.primitives.value.impl.AtomicValueOperations.REMOVE_LISTENER;
import static io.atomix.primitives.value.impl.AtomicValueOperations.SET;
