...
import io.atomix.map.impl.AtomicCounterMapOperations.GetAndAdd;
import io.atomix.map.impl.AtomicCounterMapOperations.GetAndDecrement;
import io.atomix.map.impl.AtomicCounterMapOperations.GetAndIncrement;
import io.atomix.map.impl.AtomicCounterMapOperations.IncrementAndGet;
import io.atomix.map.impl.AtomicCounterMapOperations.Put;
import io.atomix.map.impl.AtomicCounterMapOperations.PutIfAbsent;
...
import static io.atomix.map.impl.AtomicCounterMapOperations.CLEAR;
import static io.atomix.map.impl.AtomicCounterMapOperations.DECREMENT_AND_GET;
import static io.atomix.map.impl.AtomicCounterMapOperations.GET;
import static io.atomix.map.impl.AtomicCounterMapOperations.GET_AND_ADD;
import static io.atomix.map.impl.AtomicCounterMapOperations.GET_AND_DECREMENT;
import static io.atomix.map.impl.AtomicCounterMapOperations.GET_AND_INCREMENT;
import static io.atomix.map.impl.AtomicCounterMapOperations.INCREMENT_AND_GET;
import static io.atomix.map.impl.AtomicCounterMapOperations.IS_EMPTY;
import static io.atomix.map.impl.AtomicCounterMapOperations.PUT;
import static io.atomix.map.impl.AtomicCounterMapOperations.PUT_IF_ABSENT;
import static io.atomix.map.impl.AtomicCounterMapOperations.REMOVE;
import static io.atomix.map.impl.AtomicCounterMapOperations.REMOVE_VALUE;
import static io.atomix.map.impl.AtomicCounterMapOperations.REPLACE;
import static io.atomix.map.impl.AtomicCounterMapOperations.SIZE;

/**
 * {@code AsyncAtomicCounterMap} implementation backed by Atomix.
 */
public class AtomicCounterMapProxy extends AbstractRaftPrimitive implements AsyncAtomicCounterMap<String> {
