...
import io.atomix.map.impl.RaftAtomicCounterMapOperations.AddAndGet;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.DecrementAndGet;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.Get;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.GetAndAdd;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.GetAndDecrement;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.GetAndIncrement;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.IncrementAndGet;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.Put;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.PutIfAbsent;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.Remove;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.RemoveValue;
import io.atomix.map.impl.RaftAtomicCounterMapOperations.Replace;
...
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.ADD_AND_GET;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.CLEAR;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.DECREMENT_AND_GET;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.GET;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.GET_AND_ADD;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.GET_AND_DECREMENT;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.GET_AND_INCREMENT;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.INCREMENT_AND_GET;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.IS_EMPTY;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.PUT;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.PUT_IF_ABSENT;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.REMOVE;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.REMOVE_VALUE;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.REPLACE;
import static io.atomix.map.impl.RaftAtomicCounterMapOperations.SIZE;
