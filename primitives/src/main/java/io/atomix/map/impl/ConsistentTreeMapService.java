...
import io.atomix.map.impl.ConsistentTreeMapOperations.FloorKey;
import io.atomix.map.impl.ConsistentTreeMapOperations.HigherEntry;
...
import io.atomix.map.impl.ConsistentTreeMapOperations.SubMap;
...
import static io.atomix.map.impl.ConsistentTreeMapOperations.CEILING_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.CEILING_KEY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.FIRST_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.FIRST_KEY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.FLOOR_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.FLOOR_KEY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.HIGHER_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.HIGHER_KEY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.LAST_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.LAST_KEY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.LOWER_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.LOWER_KEY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.POLL_FIRST_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.POLL_LAST_ENTRY;
import static io.atomix.map.impl.ConsistentTreeMapOperations.SUB_MAP;
