...
import io.atomix.map.impl.ConsistentMapOperations.RemoveValue;
import io.atomix.map.impl.ConsistentMapOperations.RemoveVersion;
...
import static io.atomix.map.impl.ConsistentMapOperations.REMOVE;
import static io.atomix.map.impl.ConsistentMapOperations.REMOVE_LISTENER;
import static io.atomix.map.impl.ConsistentMapOperations.REMOVE_VALUE;
import static io.atomix.map.impl.ConsistentMapOperations.REMOVE_VERSION;
import static io.atomix.map.impl.ConsistentMapOperations.REPLACE;
import static io.atomix.map.impl.ConsistentMapOperations.REPLACE_VALUE;
import static io.atomix.map.impl.ConsistentMapOperations.REPLACE_VERSION;
import static io.atomix.map.impl.ConsistentMapOperations.ROLLBACK;
import static io.atomix.map.impl.ConsistentMapOperations.SIZE;
import static io.atomix.map.impl.ConsistentMapOperations.VALUES;

/**
 * Distributed resource providing the {@link AsyncConsistentMap} primitive.
 */
public class ConsistentMapProxy extends AbstractRaftPrimitive implements AsyncConsistentMap<String, byte[]> {
