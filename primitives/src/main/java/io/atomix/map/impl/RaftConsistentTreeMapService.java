...
import io.atomix.map.impl.RaftConsistentTreeMapOperations.CeilingEntry;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.CeilingKey;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.FloorEntry;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.FloorKey;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.HigherEntry;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.HigherKey;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.LowerEntry;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.LowerKey;
import io.atomix.map.impl.RaftConsistentTreeMapOperations.SubMap;
...
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.CEILING_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.CEILING_KEY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.FIRST_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.FIRST_KEY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.FLOOR_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.FLOOR_KEY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.HIGHER_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.HIGHER_KEY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.LAST_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.LAST_KEY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.LOWER_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.LOWER_KEY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.POLL_FIRST_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.POLL_LAST_ENTRY;
import static io.atomix.map.impl.RaftConsistentTreeMapOperations.SUB_MAP;
