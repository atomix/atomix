...
import io.atomix.leadership.impl.LeaderElectorOperations.Anoint;
import io.atomix.leadership.impl.LeaderElectorOperations.Evict;
import io.atomix.leadership.impl.LeaderElectorOperations.Promote;
import io.atomix.leadership.impl.LeaderElectorOperations.Run;
...
import static io.atomix.leadership.impl.LeaderElectorEvents.CHANGE;
import static io.atomix.leadership.impl.LeaderElectorOperations.ADD_LISTENER;
import static io.atomix.leadership.impl.LeaderElectorOperations.ANOINT;
import static io.atomix.leadership.impl.LeaderElectorOperations.EVICT;
import static io.atomix.leadership.impl.LeaderElectorOperations.GET_LEADERSHIP;
import static io.atomix.leadership.impl.LeaderElectorOperations.PROMOTE;
import static io.atomix.leadership.impl.LeaderElectorOperations.REMOVE_LISTENER;
import static io.atomix.leadership.impl.LeaderElectorOperations.RUN;
import static io.atomix.leadership.impl.LeaderElectorOperations.WITHDRAW;

/**
 * Distributed resource providing the {@link AsyncLeaderElector} primitive.
 */
public class LeaderElectorProxy extends AbstractRaftPrimitive implements AsyncLeaderElector<byte[]> {
