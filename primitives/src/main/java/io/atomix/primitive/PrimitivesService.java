...
public interface PrimitivesService {
  ...
  default Set<String> getConsistentMapNames() {
    return getPrimitiveNames(PrimitiveTypes.CONSISTENT_MAP);
  }
  ...
  default Set<String> getDocumentTreeNames() {
    return getPrimitiveNames(PrimitiveTypes.DOCUMENT_TREE);
  }
  ...
  default Set<String> getConsistentTreeMapNames() {
    return getPrimitiveNames(PrimitiveTypes.CONSISTENT_TREEMAP);
  }
  ...
  default Set<String> getConsistentMultimapNames() {
    return getPrimitiveNames(PrimitiveTypes.CONSISTENT_MULTIMAP);
  }
  ...
  default Set<String> getAtomicCounterMapNames() {
    return getPrimitiveNames(PrimitiveTypes.COUNTER_MAP);
  }
  ...
  default Set<String> getAtomicIdGeneratorNames() {
    return getPrimitiveNames(PrimitiveTypes.ID_GENERATOR);
  }
  ...
  default Set<String> getLeaderElectorNames() {
    return getPrimitiveNames(PrimitiveTypes.LEADER_ELECTOR);
  }
  ...
  default Set<String> getWorkQueueNames() {
    return getPrimitiveNames(PrimitiveTypes.WORK_QUEUE);
  }
