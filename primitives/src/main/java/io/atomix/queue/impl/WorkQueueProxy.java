...
import static io.atomix.queue.impl.WorkQueueEvents.TASK_AVAILABLE;
import static io.atomix.queue.impl.WorkQueueOperations.ADD;
import static io.atomix.queue.impl.WorkQueueOperations.CLEAR;
import static io.atomix.queue.impl.WorkQueueOperations.COMPLETE;
import static io.atomix.queue.impl.WorkQueueOperations.REGISTER;
import static io.atomix.queue.impl.WorkQueueOperations.STATS;
import static io.atomix.queue.impl.WorkQueueOperations.TAKE;
import static io.atomix.queue.impl.WorkQueueOperations.UNREGISTER;
 ...
 */
public class WorkQueueProxy extends AbstractRaftPrimitive implements AsyncWorkQueue<byte[]> {
