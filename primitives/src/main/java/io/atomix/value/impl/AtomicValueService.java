...
import io.atomix.value.impl.AtomicValueOperations.Set;

import java.util.Arrays;
import java.util.HashSet;

import static io.atomix.value.impl.AtomicValueEvents.CHANGE;
import static io.atomix.value.impl.AtomicValueOperations.ADD_LISTENER;
import static io.atomix.value.impl.AtomicValueOperations.COMPARE_AND_SET;
import static io.atomix.value.impl.AtomicValueOperations.GET;
import static io.atomix.value.impl.AtomicValueOperations.GET_AND_SET;
import static io.atomix.value.impl.AtomicValueOperations.REMOVE_LISTENER;
import static io.atomix.value.impl.AtomicValueOperations.SET;
