...
import io.atomix.value.impl.RaftAtomicValueOperations.CompareAndSet;
import io.atomix.value.impl.RaftAtomicValueOperations.GetAndSet;
import io.atomix.value.impl.RaftAtomicValueOperations.Set;
...
import static io.atomix.value.impl.RaftAtomicValueEvents.CHANGE;
import static io.atomix.value.impl.RaftAtomicValueOperations.ADD_LISTENER;
import static io.atomix.value.impl.RaftAtomicValueOperations.COMPARE_AND_SET;
import static io.atomix.value.impl.RaftAtomicValueOperations.GET;
import static io.atomix.value.impl.RaftAtomicValueOperations.GET_AND_SET;
import static io.atomix.value.impl.RaftAtomicValueOperations.REMOVE_LISTENER;
import static io.atomix.value.impl.RaftAtomicValueOperations.SET;
