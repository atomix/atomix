 ...
 */
package io.atomix.leadership.impl;
...
/**
 * Unit tests for {@link LeaderElectorProxy}.
 */
public class LeaderElectorTest extends AbstractPrimitiveTest<LeaderElectorProxy> {
  ...
  @Override
  protected LeaderElectorProxy createPrimitive(PrimitiveProxy proxy) {
    return new LeaderElectorProxy(proxy);
  }

  @Test
  public void testRun() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-run");
    ...
    LeaderElectorProxy elector2 = newPrimitive("test-elector-run");
  ...
  public void testWithdraw() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-withdraw");
    elector1.run(node1).join();
    LeaderElectorProxy elector2 = newPrimitive("test-elector-withdraw");
  ...
  public void testAnoint() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-anoint");
    LeaderElectorProxy elector2 = newPrimitive("test-elector-anoint");
    LeaderElectorProxy elector3 = newPrimitive("test-elector-anoint");
    elector1.run(node1).join();
    elector2.run(node2).join();
  ...
  public void testPromote() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-promote");
    LeaderElectorProxy elector2 = newPrimitive("test-elector-promote");
    LeaderElectorProxy elector3 = newPrimitive("test-elector-promote");
    elector1.run(node1).join();
    elector2.run(node2).join();
  ...
  public void testLeaderSessionClose() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-leader-session-close");
    elector1.run(node1).join();
    LeaderElectorProxy elector2 = newPrimitive("test-elector-leader-session-close");
  ...
  public void testNonLeaderSessionClose() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-non-leader-session-close");
    elector1.run(node1).join();
    LeaderElectorProxy elector2 = newPrimitive("test-elector-non-leader-session-close");
    LeaderEventListener listener = new LeaderEventListener();
    elector2.run(node2).join();
  ...
  public void testQueries() throws Throwable {
    LeaderElectorProxy elector1 = newPrimitive("test-elector-query");
    LeaderElectorProxy elector2 = newPrimitive("test-elector-query");
    elector1.run(node1).join();
    elector2.run(node2).join();
    elector2.run(node2).join();
