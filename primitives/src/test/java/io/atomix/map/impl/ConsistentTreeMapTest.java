 ...
 */
public class ConsistentTreeMapTest extends AbstractPrimitiveTest<ConsistentTreeMapProxy> {
  ...
  @Override
  protected ConsistentTreeMapProxy createPrimitive(PrimitiveProxy proxy) {
    return new ConsistentTreeMapProxy(proxy);
  }

  /**
   * Tests of the functionality associated with the
   * {@link io.atomix.map.AsyncConsistentTreeMap} interface
  ...
  public void testBasicMapOperations() throws Throwable {
    ...
    //primary purpose.
    ConsistentTreeMapProxy map = createResource("basicTestMap");
    //test size
  ...
  public void mapListenerTests() throws Throwable {
    ...
    ConsistentTreeMapProxy map = createResource("treeMapListenerTestMap");
  ...
  /**
   * Tests functionality specified in the {@link ConsistentTreeMapProxy}
  ...
  public void treeMapFunctionsTest() {
    ConsistentTreeMapProxy map = createResource("treeMapFunctionTestMap");
    //Tests on empty map
  ...
  private ConsistentTreeMapProxy createResource(String mapName) {
    try {
      ConsistentTreeMapProxy map = newPrimitive(mapName);
      return map;
    } catch (Throwable e) {
