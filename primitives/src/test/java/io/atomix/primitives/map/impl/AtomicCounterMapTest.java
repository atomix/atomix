 ...
 */
public class AtomicCounterMapTest extends AbstractPrimitiveTest<AtomicCounterMapProxy> {
  ...
  @Override
  protected AtomicCounterMapProxy createPrimitive(PrimitiveProxy proxy) {
    return new AtomicCounterMapProxy(proxy);
  }
  ...
  public void testBasicCounterMapOperations() throws Throwable {
    AtomicCounterMapProxy map = newPrimitive("testBasicCounterMapOperationMap");
