 ...
 */
public class ConsistentMapTest extends AbstractPrimitiveTest<ConsistentMapProxy> {
  ...
  @Override
  protected ConsistentMapProxy createPrimitive(PrimitiveProxy proxy) {
    return new ConsistentMapProxy(proxy);
  }
  ...
  public void testNullValues() throws Throwable {
    ...
    ConsistentMapProxy map = newPrimitive("testNullValues");
  ...
  protected void basicMapOperationTests() throws Throwable {
    ...
    ConsistentMapProxy map = newPrimitive("testBasicMapOperationMap");
  ...
  public void mapComputeOperationTests() throws Throwable {
    ...
    ConsistentMapProxy map = newPrimitive("testMapComputeOperationsMap");
  ...
  protected void mapListenerTests() throws Throwable {
    ...
    ConsistentMapProxy map = newPrimitive("testMapListenerMap");
  ...
  protected void transactionPrepareTests() throws Throwable {
    ConsistentMapProxy map = newPrimitive("testPrepareTestsMap");
  ...
  protected void transactionCommitTests() throws Throwable {
    ...
    ConsistentMapProxy map = newPrimitive("testCommitTestsMap");
    TestMapEventListener listener = new TestMapEventListener();
  ...
  protected void transactionRollbackTests() throws Throwable {
    ...
    ConsistentMapProxy map = newPrimitive("testTransactionRollbackTestsMap");
    TestMapEventListener listener = new TestMapEventListener();
