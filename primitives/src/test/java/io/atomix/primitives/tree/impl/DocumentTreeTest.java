 ...
 */
public class DocumentTreeTest extends AbstractPrimitiveTest<DocumentTreeProxy> {
  ...
  @Override
  protected DocumentTreeProxy createPrimitive(PrimitiveProxy proxy) {
    return new DocumentTreeProxy(proxy);
  }

  @Override
  protected DocumentTreeProxy newPrimitive(String name) {
    return newPrimitive(name, Ordering.NATURAL);
  }

  protected DocumentTreeProxy newPrimitive(String name, Ordering ordering) {
  ...
  public void testQueries() throws Throwable {
    DocumentTreeProxy tree = newPrimitive(UUID.randomUUID().toString());
  ...
  public void testOrder() throws Throwable {
    DocumentTreeProxy naturalTree = newPrimitive(UUID.randomUUID().toString(), Ordering.NATURAL);
    ...
    DocumentTreeProxy insertionTree = newPrimitive(UUID.randomUUID().toString(), Ordering.INSERTION);
  ...
  public void testFilteredNotifications() throws Throwable {
    ...
    DocumentTreeProxy tree1 = newPrimitive(treeName);
    DocumentTreeProxy tree2 = newPrimitive(treeName);
  ...
  private static class TestEventListener implements DocumentTreeListener<byte[]> {
    ...
    private final Queue<DocumentTreeEvent<byte[]>> queue;
