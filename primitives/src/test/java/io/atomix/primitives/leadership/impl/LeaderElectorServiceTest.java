 ...
 */
public class LeaderElectorServiceTest {
  @Test
  public void testSnapshot() throws Exception {
    ServiceContext context = mock(ServiceContext.class);
    when(context.serviceType()).thenReturn(PrimitiveTypes.leaderElector());
    ...
    LeaderElectorService service = new LeaderElectorService();
    ...
    service.run(new DefaultCommit<>(
        2,
        RUN,
        new LeaderElectorOperations.Run(id),
        session,
    ...
    service = new LeaderElectorService();
    service.init(context);
