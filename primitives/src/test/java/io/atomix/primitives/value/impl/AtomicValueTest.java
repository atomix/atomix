 ...
 */
public class AtomicValueTest extends AbstractPrimitiveTest<AtomicValueProxy> {
  @Override
  ...
  @Override
  protected AtomicValueProxy createPrimitive(PrimitiveProxy proxy) {
    return new AtomicValueProxy(proxy);
  }
  ...
  public void testValue() throws Exception {
    ...
    AtomicValueProxy value = newPrimitive("test-value");
