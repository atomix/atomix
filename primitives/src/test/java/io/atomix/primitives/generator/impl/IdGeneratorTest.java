...
import io.atomix.primitives.counter.impl.AtomicCounterService;
 ...
 */
public class IdGeneratorTest extends AbstractPrimitiveTest<AtomicCounterProxy> {
  ...
  @Override
  protected AtomicCounterProxy createPrimitive(PrimitiveProxy proxy) {
    return new AtomicCounterProxy(proxy);
  }
  ...
  public void testNextId() throws Throwable {
    DelegatingIdGenerator idGenerator1 = new DelegatingIdGenerator(newPrimitive("testNextId"));
    DelegatingIdGenerator idGenerator2 = new DelegatingIdGenerator(newPrimitive("testNextId"));
  ...
  public void testNextIdBatchRollover() throws Throwable {
    DelegatingIdGenerator idGenerator1 = new DelegatingIdGenerator(newPrimitive("testNextIdBatchRollover"), 2);
    DelegatingIdGenerator idGenerator2 = new DelegatingIdGenerator(newPrimitive("testNextIdBatchRollover"), 2);
