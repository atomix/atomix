 ...
 */
public class WorkQueueTest extends AbstractPrimitiveTest<WorkQueueProxy> {
  ...
  @Override
  protected WorkQueueProxy createPrimitive(PrimitiveProxy proxy) {
    return new WorkQueueProxy(proxy);
  }

  @Test
  public void testAdd() throws Throwable {
    String queueName = UUID.randomUUID().toString();
    WorkQueueProxy queue1 = newPrimitive(queueName);
    byte[] item = DEFAULT_PAYLOAD;
    queue1.addOne(item).join();

    WorkQueueProxy queue2 = newPrimitive(queueName);
