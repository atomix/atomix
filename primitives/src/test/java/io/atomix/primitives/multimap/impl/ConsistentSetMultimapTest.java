 ...
 */
public class ConsistentSetMultimapTest extends AbstractPrimitiveTest<ConsistentSetMultimapProxy> {
  ...
  @Override
  protected ConsistentSetMultimapProxy createPrimitive(PrimitiveProxy proxy) {
    return new ConsistentSetMultimapProxy(proxy);
  }
  ...
  public void testSize() throws Throwable {
    ConsistentSetMultimapProxy map = createResource("testOneMap");
  ...
  public void containsTest() throws Throwable {
    ConsistentSetMultimapProxy map = createResource("testTwoMap");
  ...
  public void addAndRemoveTest() throws Exception {
    ConsistentSetMultimapProxy map = createResource("testThreeMap");
  ...
  public void testAccessors() throws Exception {
    ConsistentSetMultimapProxy map = createResource("testFourMap");
  ...
  private ConsistentSetMultimapProxy createResource(String mapName) {
    try {
      ConsistentSetMultimapProxy map = newPrimitive(mapName);
      return map;
    } catch (Throwable e) {
