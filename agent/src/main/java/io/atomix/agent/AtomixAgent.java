...
public class AtomixAgent {
  ...
  public static void main(String[] args) throws Exception {
    ...
    parser.addArgument("--http-host", "-h")
        ...
        .required(false)
        .setDefault("0.0.0.0")
        .help("Sets the interfae to which to bind the HTTP server. Defaults to 0.0.0.0 (all interfaces)")
    ...
    LOGGER.info("Atomix listening at {}:{}",
        atomix.getMembershipService().getLocalMember().address().host(),
    ...
    LOGGER.info("HTTP server listening at {}:{}", httpHost, httpPort);
