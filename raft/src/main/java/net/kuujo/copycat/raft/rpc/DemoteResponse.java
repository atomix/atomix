...
/**
 * Protocol demote response.
 *
 * @author <a href="http://github.com/kuujo">Jordan Halterman</a>
 */
public class DemoteResponse extends AbstractResponse<DemoteResponse> {
  ...
  /**
   * Returns a new demote response builder.
   *
   * @return A new demote response builder.
   */
  ...
  /**
   * Returns a demote response builder for an existing response.
   *
   * @param response The response to build.
   * @return The demote response builder.
   */
  public static Builder builder(DemoteResponse response) {
  ...
  public DemoteResponse(ReferenceManager<DemoteResponse> referenceManager) {
  ...
  public boolean equals(Object object) {
    if (object instanceof DemoteResponse) {
      DemoteResponse response = (DemoteResponse) object;
  ...
  /**
   * Demote response builder.
   */
  public static class Builder extends AbstractResponse.Builder<Builder, DemoteResponse> {

    private Builder() {
      super(DemoteResponse::new);
    }
