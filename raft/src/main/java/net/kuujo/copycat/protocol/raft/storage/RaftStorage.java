...
public interface RaftStorage extends AutoCloseable {
   ...
   * @throws net.kuujo.copycat.protocol.raft.storage.CommitModificationException If the entry's index does not match
   ...
   * @return The Raft log.
   */
  RaftStorage filter(RaftEntryFilter filter);
   ...
   * Raft log builder.
   */
  static interface Builder extends net.kuujo.copycat.Builder<RaftStorage> {
  }
