...
public interface RaftLog extends AutoCloseable {
   ...
   * <p>
   * The returned index is the index that will be assigned to the next entry created via {@link RaftLog#createEntry()}.
   *
   ...
   * <p>
   * In contrast to {@link RaftLog#commit(long)} which makes entries available for compaction via deduplication, this
