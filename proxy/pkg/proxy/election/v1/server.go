...
import (
	...
	electionv1 "github.com/atomix/atomix/api/pkg/primitive/election/v1"
...
func newLeaderElectionServer(delegate *proxy.Delegate[electionv1.LeaderElectionServer]) electionv1.LeaderElectionServer {
...
type leaderElectionServer struct {
	delegate *proxy.Delegate[electionv1.LeaderElectionServer]
}
