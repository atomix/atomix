...
import (
	...
	counterproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/counter/v1"
	countermapproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/countermap/v1"
	electionproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/election/v1"
	indexedmapproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/indexedmap/v1"
	listproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/list/v1"
	lockproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/lock/v1"
	mapproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/map/v1"
	multimapproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/multimap/v1"
	setproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/set/v1"
	topicproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/topic/v1"
	runtime "github.com/atomix/atomix/proxy/pkg/runtime/v1"
	valueproxyv1 "github.com/atomix/atomix/proxy/pkg/runtime/value/v1"
