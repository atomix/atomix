 ...
 */
package net.kuujo.copycat.cluster.protocol;

import net.kuujo.copycat.cluster.EventListener;
...
public interface Connection extends ProtocolReader, ProtocolWriter {
   ...
   */
  Connection closeListener(EventListener<Void> listener);
   ...
   * @return The protocol connection.
   */
  Connection exceptionListener(EventListener<Throwable> listener);
