...
func newLeaderElectionServer(client *runtime.PrimitiveClient[LeaderElection]) electionv1.LeaderElectionServer {
...
type leaderElectionServer struct {
	client *runtime.PrimitiveClient[LeaderElection]
}
