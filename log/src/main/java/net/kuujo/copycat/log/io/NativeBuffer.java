...
import net.kuujo.copycat.log.io.util.NativeAllocator;
...
public class NativeBuffer extends CheckedBuffer {
   ...
   * <p>
   * When the buffer is constructed, {@link net.kuujo.copycat.log.io.util.NativeAllocator} will be used to allocate
