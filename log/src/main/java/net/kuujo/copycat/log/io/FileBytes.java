...
public class FileBytes implements Bytes {
  ...
  public Bytes read(Bytes bytes, long offset, long length) {
    ...
    try {
      ...
      for (long i = offset; i < length; i++) {
        bytes.writeByte(i - offset, file.readByte());
      }
    } catch (IOException e) {
  ...
  public Bytes read(byte[] bytes, long offset, long length) {
    ...
    try {
      seekToOffset(offset);
      file.read(bytes, (int) offset, (int) length);
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
    return this;
  ...
  public Bytes write(Bytes bytes, long offset, long length) {
    ...
    try {
      seekToOffset(offset);
      for (long i = offset; i < length; i++) {
        file.writeByte(bytes.readByte(i - offset));
      }
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  ...
  public Bytes write(byte[] bytes, long offset, long length) {
    ...
    try {
      seekToOffset(offset);
      file.write(bytes, (int) offset, (int) length);
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
    return this;
