 ...
 * The buffer abstraction allows Copycat's {@link net.kuujo.copycat.io.log.Log} to write to memory or disk based on the
 * buffer type.
 * <p>
 ...
 * {@link net.kuujo.copycat.io.log.EntryFilter filtering} entries out of the segment, and rewriting the segment to a new
