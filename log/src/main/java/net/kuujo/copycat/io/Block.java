...
public class Block extends CheckedBuffer implements ReferenceCounted<Block> {
   ...
   * via {@link net.kuujo.copycat.io.BlockReader#close()} to release the reader back to the block. This allows blocks to recycle existing
   * readers with {@link net.kuujo.copycat.io.ReusableBlockReaderPool} rather than creating a new block for each new write.
   *
