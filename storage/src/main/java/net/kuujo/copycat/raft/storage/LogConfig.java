...
import net.kuujo.copycat.raft.storage.compact.FullRetentionPolicy;
import net.kuujo.copycat.raft.storage.compact.LeveledCompactionStrategy;
...
/**
 * Copycat log configuration.
 * <p>
 * The log configuration is used to create log files, allocate disk space and predict disk usage for each segment in
 * the log.
 *
