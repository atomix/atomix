 ...
 */
abstract class AbstractCopycatContext implements BaseCopycatContext {
  protected final StateContext state;
  protected final Cluster<?> cluster;
  protected final CopycatConfig config;
  protected final Events events;

  protected AbstractCopycatContext(StateContext state, Cluster<?> cluster, CopycatConfig config) {
    this.state = state;
