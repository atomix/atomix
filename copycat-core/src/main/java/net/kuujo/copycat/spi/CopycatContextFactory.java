 ...
 */
public interface CopycatContextFactory {
   ...
   */
  <M extends Member> CopycatContext createContext(StateMachine stateMachine, Log log, Cluster<M> cluster, Protocol<M> protocol, CopycatConfig config);
