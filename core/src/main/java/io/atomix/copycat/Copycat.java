...
/**
 * Base type for creating and managing distributed {@link Resource resources} in a Copycat cluster.
 * <p>
 ...
 * When a resource is created, the {@link io.atomix.catalog.server.StateMachine} associated with the resource will be created on each Raft server
 ...
 * {@link io.atomix.catalog.client.Command commands} and {@link io.atomix.catalog.client.Query queries} to the underlying
...
public abstract class Copycat implements Managed<Copycat> {
   ...
   * Copycat builder.
   */
  public static abstract class Builder extends io.atomix.catalyst.util.Builder<Copycat> {
