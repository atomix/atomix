 ...
 */
public class DefaultWorkQueue<E> extends Synchronous<AsyncWorkQueue<E>> implements WorkQueue<E> {

  private static final int MAX_DELAY_BETWEEN_RETRY_MILLS = 50;
  private final AsyncWorkQueue<E> asyncQueue;
  private final long operationTimeoutMillis;

  public DefaultWorkQueue(AsyncWorkQueue<E> asyncQueue, long operationTimeoutMillis) {
    super(asyncQueue);
