 ...
 * <p>
 * This enum provides identifiers for configurable {@link DistributedResource} consistency levels. Each operation
 ...
 * the operation.
 * <p>
 * The consistency level of a resource can be configured via {@link DistributedResource#with(Consistency)}.
 * <pre>
 *   {@code
 ...
 * In those cases, consistency levels may be explicitly overridden by specific {@link DistributedResource} implementations.
