...
import io.atomix.storage.memory.DirectMemory;
import io.atomix.storage.memory.Memory;
...
public class UnsafeDirectBuffer extends NativeBuffer {
   ...
   * <p>
   * When the buffer is constructed, {@link io.atomix.storage.memory.DirectMemoryAllocator} will be used to allocate
