 ...
 */
public class QueryMessage extends OperationMessage {
    ...
    public QueryMessage(long session, long sequence, byte[] bytes, long index, RaftQuery.ConsistencyLevel consistency) {
    ...
    public boolean equals(Object object) {
        if (object instanceof QueryMessage) {
            QueryMessage request = (QueryMessage) object;
     ...
     */
    public static class Builder extends OperationMessage.Builder<Builder, QueryMessage> {
        private long index;
        ...
        public QueryMessage build() {
            validate();
            return new QueryMessage(session, sequence, bytes, index, consistency);
        }
    }
