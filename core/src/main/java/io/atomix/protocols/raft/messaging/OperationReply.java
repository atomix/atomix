 ...
 */
public abstract class OperationReply extends SessionReply {
    protected final long index;
    protected final long eventIndex;
    protected final Object result;
    protected final long lastSequence;

    public OperationReply(Status status, RaftError error, long index, long eventIndex, Object result, long lastSequence) {
        super(status, error);
        this.index = index;
    ...
    public boolean equals(Object object) {
        if (getClass().isAssignableFrom(object.getClass())) {
            OperationReply response = (OperationReply) object;
     ...
     */
    public static abstract class Builder<T extends Builder<T, U>, U extends OperationReply> extends SessionReply.Builder<T, U> {
