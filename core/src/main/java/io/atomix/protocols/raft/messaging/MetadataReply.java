 ...
 */
public class MetadataReply extends AbstractRaftReply {
    ...
    public MetadataReply(Status status, RaftError error, Set<RaftSessionMetadata> sessions) {
        super(status, error);
     ...
     */
    public static class Builder extends AbstractRaftReply.Builder<Builder, MetadataReply> {
        ...
        @Override
        public MetadataReply build() {
            validate();
            return new MetadataReply(status, error, sessions);
        }
    }
}
