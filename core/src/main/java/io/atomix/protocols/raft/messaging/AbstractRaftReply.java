 ...
 */
public abstract class AbstractRaftReply implements RaftReply {
    protected final Status status;
    protected final RaftError error;

    protected AbstractRaftReply(Status status, RaftError error) {
        this.status = status;
        this.error = error;
    }
    ...
    public boolean equals(Object object) {
        if (object.getClass() == getClass()) {
            AbstractRaftReply response = (AbstractRaftReply) object;
     ...
     */
    protected static abstract class Builder<T extends Builder<T, U>, U extends AbstractRaftReply> implements RaftReply.Builder<T, U> {
