 ...
 */
public abstract class SessionMessage extends AbstractRaftMessage {
  protected final long session;

  protected SessionMessage(long session) {
  ...
  public boolean equals(Object object) {
    if (object.getClass() == getClass()) {
      SessionMessage request = (SessionMessage) object;
   ...
   */
  public static abstract class Builder<T extends Builder<T, U>, U extends SessionMessage> extends AbstractRaftMessage.Builder<T, U> {
