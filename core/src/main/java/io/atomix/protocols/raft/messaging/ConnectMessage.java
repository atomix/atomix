 ...
 */
public class ConnectMessage extends AbstractRaftMessage {
  ...
  public ConnectMessage(long session, long connection) {
  ...
  public boolean equals(Object object) {
    return object instanceof ConnectMessage && ((ConnectMessage) object).session == session;
  }
   ...
   */
  public static class Builder extends AbstractRaftMessage.Builder<Builder, ConnectMessage> {
    ...
    public ConnectMessage build() {
      validate();
      return new ConnectMessage(session, connection);
    }
  }
}
