 ...
 */
public class CommandMessage extends OperationMessage {
  ...
  public CommandMessage(long session, long sequence, byte[] bytes) {
  ...
  public boolean equals(Object object) {
    if (object instanceof CommandMessage) {
      CommandMessage request = (CommandMessage) object;
   ...
   */
  public static class Builder extends OperationMessage.Builder<Builder, CommandMessage> {
    @Override
    public CommandMessage build() {
      validate();
      return new CommandMessage(session, sequence, bytes);
    }
  }
}
