 ...
 */
public class OpenSessionMessage extends AbstractRaftMessage {
  ...
  public OpenSessionMessage(String client, String name, String stateMachine, long timeout) {
    this.client = client;
    this.name = name;
  ...
  public boolean equals(Object object) {
    if (object instanceof OpenSessionMessage) {
      OpenSessionMessage request = (OpenSessionMessage) object;
   ...
   */
  public static class Builder extends AbstractRaftMessage.Builder<Builder, OpenSessionMessage> {
     ...
     */
    @Override
    public OpenSessionMessage build() {
      validate();
      return new OpenSessionMessage(client, name, stateMachine, timeout);
    }
  }
}
