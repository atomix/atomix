 ...
 */
public class OpenSessionReply extends AbstractRaftReply {
    ...
    public OpenSessionReply(Status status, RaftError error, long session, long timeout) {
        super(status, error);
    ...
    public boolean equals(Object object) {
        if (object instanceof OpenSessionReply) {
            OpenSessionReply response = (OpenSessionReply) object;
     ...
     */
    public static class Builder extends AbstractRaftReply.Builder<Builder, OpenSessionReply> {
        ...
        @Override
        public OpenSessionReply build() {
            validate();
            return new OpenSessionReply(status, error, session, timeout);
        }
    }
}
