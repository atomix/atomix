...
public class RaftServer {
   ...
   * list provided to the server {@link #builder(NodeId) builder}. For {@link io.atomix.protocols.raft.storage.StorageLevel#DISK persistent}
  ...
  public static class Builder implements io.atomix.util.Builder<RaftServer> {
    ...
    public RaftServer build() {
      ...
      RaftServerContext context = new RaftServerContext(name, type, localNodeId, protocol, storage, stateMachineRegistry, threadPool, threadContext);
