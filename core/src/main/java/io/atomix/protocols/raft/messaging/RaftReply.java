 ...
 * <p>
 * Each response has a non-null {@link RaftReply.Status} of either {@link RaftReply.Status#OK} or
 * {@link RaftReply.Status#ERROR}. Responses where {@link #status()} is {@link RaftReply.Status#ERROR}
 * may provide an optional {@link #error()} code.
 *
 * @author <a href="http://github.com/kuujo">Jordan Halterman</a>
 */
public interface RaftReply {
   ...
   */
  interface Builder<T extends Builder<T, U>, U extends RaftReply> extends io.atomix.util.Builder<U> {
