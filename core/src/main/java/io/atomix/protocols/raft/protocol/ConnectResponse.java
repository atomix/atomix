 ...
 */
public class ConnectResponse extends AbstractRaftResponse {
    ...
    public ConnectResponse(Status status, RaftError error, NodeId leader, Collection<NodeId> members) {
        super(status, error);
        this.leader = leader;
     ...
     */
    public static class Builder extends AbstractRaftResponse.Builder<Builder, ConnectResponse> {
