 ...
 * <p>
 * Session keep alive responses are sent upon the completion of a {@link KeepAliveMessage}
 ...
 */
public class KeepAliveReply extends AbstractRaftReply {
    ...
    public KeepAliveReply(Status status, RaftError error, NodeId leader, Collection<NodeId> members) {
        super(status, error);
        this.leader = leader;
    ...
    public boolean equals(Object object) {
        if (object instanceof KeepAliveReply) {
            KeepAliveReply response = (KeepAliveReply) object;
     ...
     */
    public static class Builder extends AbstractRaftReply.Builder<Builder, KeepAliveReply> {
         ...
         */
        @Override
        public KeepAliveReply build() {
            validate();
            return new KeepAliveReply(status, error, leader, members);
        }
    }
}
