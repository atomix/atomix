...
/**
 * Standard java {@link Map} backed by a {@link AtomicMap}.
 *
 * @param <K> key type
 * @param <V> value type
 */
public final class AtomicMapBackedJavaMap<K, V> implements Map<K, V> {

  private final AtomicMap<K, V> backingMap;

  public AtomicMapBackedJavaMap(AtomicMap<K, V> backingMap) {
