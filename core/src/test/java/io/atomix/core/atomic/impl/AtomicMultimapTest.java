...
import io.atomix.core.atomic.impl.AtomicMultimapProxy;
...
public abstract class AtomicMultimapTest extends AbstractPrimitiveTest {
  ...
  public void testMultimapViews() throws Exception {
    AtomicMultimap<String, String> map = atomix().<String, String>consistentMultimapBuilder("testMultimapViews", protocol()).build();
