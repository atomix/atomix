...
public abstract class AtomicMapTest extends AbstractPrimitiveTest {
  ...
  public void testBasicMapOperations() throws Throwable {
    ...
    AsyncAtomicMap<String, String> map = atomix().<String, String>consistentMapBuilder("testBasicMapOperationMap", protocol()).build().async();
  ...
  public void testMapComputeOperations() throws Throwable {
    ...
    AsyncAtomicMap<String, String> map = atomix().<String, String>consistentMapBuilder("testMapComputeOperationsMap", protocol()).build().async();
  ...
  public void testMapListeners() throws Throwable {
    ...
    AsyncAtomicMap<String, String> map = atomix().<String, String>consistentMapBuilder("testMapListenerMap", protocol()).build().async();
  ...
  public void testMapViews() throws Exception {
    AtomicMap<String, String> map = atomix().<String, String>consistentMapBuilder("testMapViews", protocol()).build();
  ...
  public void testTransaction() throws Throwable {
    ...
    AtomicMap<String, String> map = atomix().<String, String>consistentMapBuilder("test-transactional-map", protocol()).build();
