...
/**
 * Distributed value configuration test.
 */
public class DistributedValueConfigTest {
  @Test
  public void testLoadConfig() throws Exception {
    DistributedValueConfig config = Atomix.config(getClass().getClassLoader().getResource("primitives.conf").getPath())
        .getPrimitive("value");
