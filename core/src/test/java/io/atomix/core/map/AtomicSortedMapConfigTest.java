...
public class AtomicSortedMapConfigTest {
  ...
  public void testLoadConfig() throws Exception {
    AtomicSortedMapConfig config = Atomix.config(getClass().getClassLoader().getResource("primitives.conf").getPath())
        .getPrimitive("atomic-sorted-map");
    assertEquals("atomic-sorted-map", config.getName());
