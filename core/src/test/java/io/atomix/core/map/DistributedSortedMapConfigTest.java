...
public class DistributedSortedMapConfigTest {
  ...
  public void testLoadConfig() throws Exception {
    DistributedSortedMapConfig config = Atomix.config(getClass().getClassLoader().getResource("primitives.conf").getPath())
        .getPrimitive("sorted-map");
    assertEquals("sorted-map", config.getName());
