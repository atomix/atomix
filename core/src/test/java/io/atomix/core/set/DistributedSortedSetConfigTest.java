...
public class DistributedSortedSetConfigTest {
  ...
  public void testLoadConfig() throws Exception {
    DistributedSortedSetConfig config = Atomix.config(getClass().getClassLoader().getResource("primitives.conf").getPath())
        .getPrimitive("sorted-set");
    assertEquals("sorted-set", config.getName());
