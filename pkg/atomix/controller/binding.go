...
func newBindingExecutor(runtime runtime.Runtime) *Controller[*runtimev1.BindingId] {
	...
	return NewController(newBindingReconciler(runtime), bindingWatcher, clusterWatcher)
}
