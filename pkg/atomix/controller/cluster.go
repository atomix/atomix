...
func newClusterExecutor(runtime runtime.Runtime) *Controller[*runtimev1.ClusterId] {
	...
	return NewController[*runtimev1.ClusterId](newClusterReconciler(runtime), clusterWatcher)
}
