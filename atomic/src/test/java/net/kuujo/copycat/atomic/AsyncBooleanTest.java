 ...
 */
@Test
public class AsyncBooleanTest extends ConcurrentTestCase {
  ...
  public void testSetGet() throws Throwable {
    ...
    AsyncBoolean reference = node.create(AsyncBoolean.class).get();
    ...
    expectResume();
    reference.set(true).thenRun(this::resume);
    await();
