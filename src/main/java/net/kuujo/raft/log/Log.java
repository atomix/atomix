...
public interface Log {
   ...
   *   The entry to append.
   * @param doneHandler
   *   A handler to be called once the entry has been appended.
   * @return
   *   The log instance.
   */
   ...
   * @param index
   *   The index to check.
   * @param containsHandler
   *   A handler to be called with the contains result.
   * @return
   ...
   * @param entryHandler
   *   A handler to be called with the entry.
   * @return
   ...
   *   The command ID.
   * @param doneHandler
   *   A handler to be called once the command is freed.
   */
