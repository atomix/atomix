...
public interface ClusterController {
   ...
   *
   * @return
   *   The event bus address of the cluster.
   */
   ...
   *
   * @param doneHandler
   *   An asynchronous handler to be called once the cluster has been started.
   * @return
   *   The cluster controller.
   */
   ...
   *
   * @param handler
   *   A handler to be called when a command message is received by the cluster.
   * @return
   *   The cluster controller.
   */
   ...
   *
   * @param doneHandler
   *   An asynchronous handler to be called once the cluster has been stopped.
   */
