...
public interface ReplicationService {
   ...
   * 
   * @param config A cluster configuration.
   * @param doneHandler An asynchronous handler to be called once the service
   *          has been started.
   * @return The replication service.
   */
   ...
   * @param doneHandler An asynchronous handler to be called with the command
   *          result.
   * @return The replication service.
   */
   ...
   * Stops the replication service.
   * 
   * @param doneHandler An asynchronous handler to be called once the service is
   *          stopped.
   */
