...
public interface ClusterConfig {
  ...
  /**
   * Sets the cluster quorum size.<p>
   *
   * If the quorum size is set to <code>0</code> then the quorum will default to
   * floor(members / 2) + 1.
   *
   * @param quorumSize The cluster quorum size.
   * @return The cluster configuration.
   */
  ClusterConfig setQuorumSize(int quorumSize);
