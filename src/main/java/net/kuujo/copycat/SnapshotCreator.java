...
/**
 * Interface for implementing a snapshot creator.<p>
 *
 * This interface should be implemented by state machines in tandem with the
 * {@link SnapshotInstaller} interface. State machines which implement these
...
public interface SnapshotCreator {
  ...
  /**
   * Creates a snapshot of the machine state.
   *
