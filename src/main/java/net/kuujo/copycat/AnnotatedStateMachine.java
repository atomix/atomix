 ...
 */
public class AnnotatedStateMachine implements StateMachine, CommandProvider, SnapshotCreator, SnapshotInstaller {
  ...
  public void installSnapshot(JsonObject snapshot) {
    if (snapshotInstaller != null) {
      try {
        snapshotInstaller.call(this, snapshot);
      }
      catch (IllegalAccessException | InvocationTargetException e) {
        throw new RuntimeException(e);
      }
  ...
  public JsonObject applyCommand(String name, JsonObject args) {
    ...
    if (command != null) {
      try {
        result = command.call(this, args.toMap());
      }
      catch (IllegalAccessException | InvocationTargetException e) {
    ...
    return new JsonObject().putValue("result", result);
  }
   ...
   */
  private static class SnapshotTaker implements Function<Void, JsonObject> {
    ...
    @Override
    public JsonObject call(Object obj, Void arg) throws IllegalAccessException, InvocationTargetException {
