 ...
 * </pre>
 * <p>
 * Buffers implement {@link net.kuujo.copycat.util.ReferenceCounted} in order to keep track of the number of currently
 ...
 * {@link net.kuujo.copycat.util.ReferenceCounted#acquire()} and released via
 * {@link net.kuujo.copycat.util.ReferenceCounted#release}. Once all references to a buffer have been released - including
...
public interface Buffer extends BytesInput<Buffer>, BufferInput<Buffer>, BytesOutput<Buffer>, BufferOutput<Buffer>, ReferenceCounted<Buffer> {
   ...
   * defined by {@link net.kuujo.copycat.util.ReferenceCounted} will be decremented. However, if references to the
