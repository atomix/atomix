...
[ alt_names ]
DNS.1 = atomix-sidecar-controller.kube-system
DNS.2 = atomix-sidecar-controller.kube-system.svc
[ v3_req ]
...
openssl req -new -key certs/admission.key -out certs/admission.csr -subj "/CN=atomix-sidecar-controller.kube-system.svc" -config certs/admission.conf
...
echo ./certs/admission.key
echo ./certs/admission.crt
echo ./certs/ca.crt
