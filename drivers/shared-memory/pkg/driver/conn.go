...
func (c *sharedMemoryConn) NewCounterV1() counterruntimev1.CounterServer {
	return counterv1.NewCounter(c.Protocol)
}

func (c *sharedMemoryConn) NewCounterMapV1() countermapruntimev1.CounterMapServer {
	return countermapv1.NewCounterMap(c.Protocol)
}

func (c *sharedMemoryConn) NewLeaderElectionV1() electionruntimev1.LeaderElectionServer {
	return electionv1.NewLeaderElection(c.Protocol)
}

func (c *sharedMemoryConn) NewIndexedMap(config *indexedmapprotocolv1.IndexedMapConfig) (indexedmapruntimev1.IndexedMapServer, error) {
	return indexedmapv1.NewIndexedMap(c.Protocol, config)
}

func (c *sharedMemoryConn) NewLockV1() lockruntimev1.LockServer {
	return lockv1.NewLock(c.Protocol)
}

func (c *sharedMemoryConn) NewMapV1(config *mapprotocolv1.MapConfig) (mapruntimev1.MapServer, error) {
	return mapv1.NewMap(c.Protocol, config)
}

func (c *sharedMemoryConn) NewMultiMapV1() multimapruntimev1.MultiMapServer {
	return multimapv1.NewMultiMap(c.Protocol)
}

func (c *sharedMemoryConn) NewSetV1() setruntimev1.SetServer {
	return setv1.NewSet(c.Protocol)
}

func (c *sharedMemoryConn) NewValueV1() valueruntimev1.ValueServer {
