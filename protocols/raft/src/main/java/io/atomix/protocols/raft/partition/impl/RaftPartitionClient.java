...
public class RaftPartitionClient implements DistributedPrimitiveCreator, Managed<RaftPartitionClient> {
  ...
  public <K, V> AsyncConsistentMap<K, V> newAsyncConsistentMap(String name, Serializer serializer) {
    ConsistentMapProxy rawMap = new ConsistentMapProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public <K, V> AsyncConsistentTreeMap<K, V> newAsyncConsistentTreeMap(String name, Serializer serializer) {
    ConsistentTreeMapProxy rawMap =
        new ConsistentTreeMapProxy(client.newProxyBuilder()
            .withName(name)
  ...
  public <K, V> AsyncConsistentMultimap<K, V> newAsyncConsistentSetMultimap(String name, Serializer serializer) {
    ConsistentSetMultimapProxy rawMap =
        new ConsistentSetMultimapProxy(client.newProxyBuilder()
            .withName(name)
  ...
  public <K> AsyncAtomicCounterMap<K> newAsyncAtomicCounterMap(String name, Serializer serializer) {
    AtomicCounterMapProxy rawMap = new AtomicCounterMapProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public AsyncAtomicCounter newAsyncCounter(String name) {
    return new AtomicCounterProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public <V> AsyncAtomicValue<V> newAsyncAtomicValue(String name, Serializer serializer) {
    AtomicValueProxy value = new AtomicValueProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public <E> AsyncWorkQueue<E> newAsyncWorkQueue(String name, Serializer serializer) {
    WorkQueueProxy workQueue = new WorkQueueProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public <V> AsyncDocumentTree<V> newAsyncDocumentTree(String name, Serializer serializer, Ordering ordering) {
    DocumentTreeProxy documentTree = new DocumentTreeProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public <T> AsyncLeaderElector<T> newAsyncLeaderElector(String name, Serializer serializer, Duration electionTimeout) {
    LeaderElectorProxy leaderElector = new LeaderElectorProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public AsyncDistributedLock newAsyncDistributedLock(String name, Duration lockTimeout) {
    return new DistributedLockProxy(client.newProxyBuilder()
        .withName(name)
  ...
  public Set<String> getPrimitiveNames(PrimitiveType primitiveType) {
    return client.metadata().getSessions(primitiveType)
        .join()
        .stream()
        .map(SessionMetadata::serviceName)
