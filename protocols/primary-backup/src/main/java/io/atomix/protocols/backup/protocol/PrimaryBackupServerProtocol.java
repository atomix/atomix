...
public interface PrimaryBackupServerProtocol {
   ...
   */
  CompletableFuture<BackupResponse> backup(NodeId nodeId, BackupRequest request);
   ...
   * @return a future to be completed with the response
   */
  CompletableFuture<RestoreResponse> restore(NodeId nodeId, RestoreRequest request);
