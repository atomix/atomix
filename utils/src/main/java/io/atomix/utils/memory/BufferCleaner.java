...
public class BufferCleaner {
  ...
  static {
    final Object cleaner = AccessController.doPrivileged((PrivilegedAction<Object>) BufferCleaner::getCleaner);
    if (cleaner instanceof Cleaner) {
      ...
      LOGGER.debug("java.nio.DirectByteBuffer.cleaner(): unavailable", cleaner);
    }
  }

  private static Object getCleaner() {
