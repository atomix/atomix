...
// Package v1beta1 contains API Schema definitions for the multiraft v1beta1 API group
...
var SchemeGroupVersion = schema.GroupVersion{Group: "multiraft.atomix.io", Version: "v1beta1"}
