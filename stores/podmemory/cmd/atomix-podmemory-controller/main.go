...
import (
	...
	podmemoryapis "github.com/atomix/atomix/stores/podmemory/pkg/apis"
	podmemoryv1beta1 "github.com/atomix/atomix/stores/podmemory/pkg/controller/podmemory/v1beta1"
...
func getCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:  "atomix-podmemory-controller",
		Args: cobra.NoArgs,
