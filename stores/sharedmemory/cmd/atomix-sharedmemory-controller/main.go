...
import (
	...
	memoryapis "github.com/atomix/atomix/stores/sharedmemory/pkg/apis"
	memoryv1beta1 "github.com/atomix/atomix/stores/sharedmemory/pkg/controller/memory/v1beta1"
...
func getCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:  "atomix-sharedmemory-controller",
		Args: cobra.NoArgs,
