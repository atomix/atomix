...
type GroupConfig struct {
	...
	Role     MemberRole     `protobuf:"varint,3,opt,name=role,proto3,enum=atomix.stores.multiraft.v1.MemberRole" json:"role,omitempty"`
...
func init() {
	proto.RegisterEnum("atomix.stores.multiraft.v1.MemberRole", MemberRole_name, MemberRole_value)
	proto.RegisterType((*GroupConfig)(nil), "atomix.stores.multiraft.v1.GroupConfig")
	proto.RegisterType((*MemberConfig)(nil), "atomix.stores.multiraft.v1.MemberConfig")
	proto.RegisterType((*RaftProposal)(nil), "atomix.stores.multiraft.v1.RaftProposal")
	proto.RegisterType((*BootstrapRequest)(nil), "atomix.stores.multiraft.v1.BootstrapRequest")
	proto.RegisterType((*BootstrapResponse)(nil), "atomix.stores.multiraft.v1.BootstrapResponse")
	proto.RegisterType((*JoinRequest)(nil), "atomix.stores.multiraft.v1.JoinRequest")
	proto.RegisterType((*JoinResponse)(nil), "atomix.stores.multiraft.v1.JoinResponse")
	proto.RegisterType((*LeaveRequest)(nil), "atomix.stores.multiraft.v1.LeaveRequest")
	proto.RegisterType((*LeaveResponse)(nil), "atomix.stores.multiraft.v1.LeaveResponse")
	proto.RegisterType((*WatchRequest)(nil), "atomix.stores.multiraft.v1.WatchRequest")
	proto.RegisterType((*Event)(nil), "atomix.stores.multiraft.v1.Event")
	proto.RegisterType((*ConnectionInfo)(nil), "atomix.stores.multiraft.v1.ConnectionInfo")
	proto.RegisterType((*MemberEvent)(nil), "atomix.stores.multiraft.v1.MemberEvent")
	proto.RegisterType((*MemberReadyEvent)(nil), "atomix.stores.multiraft.v1.MemberReadyEvent")
	proto.RegisterType((*MembershipChangedEvent)(nil), "atomix.stores.multiraft.v1.MembershipChangedEvent")
	proto.RegisterType((*LeaderUpdatedEvent)(nil), "atomix.stores.multiraft.v1.LeaderUpdatedEvent")
	proto.RegisterType((*SendSnapshotStartedEvent)(nil), "atomix.stores.multiraft.v1.SendSnapshotStartedEvent")
	proto.RegisterType((*SendSnapshotCompletedEvent)(nil), "atomix.stores.multiraft.v1.SendSnapshotCompletedEvent")
	proto.RegisterType((*SendSnapshotAbortedEvent)(nil), "atomix.stores.multiraft.v1.SendSnapshotAbortedEvent")
	proto.RegisterType((*SnapshotReceivedEvent)(nil), "atomix.stores.multiraft.v1.SnapshotReceivedEvent")
	proto.RegisterType((*SnapshotRecoveredEvent)(nil), "atomix.stores.multiraft.v1.SnapshotRecoveredEvent")
	proto.RegisterType((*SnapshotCreatedEvent)(nil), "atomix.stores.multiraft.v1.SnapshotCreatedEvent")
	proto.RegisterType((*SnapshotCompactedEvent)(nil), "atomix.stores.multiraft.v1.SnapshotCompactedEvent")
	proto.RegisterType((*LogEvent)(nil), "atomix.stores.multiraft.v1.LogEvent")
	proto.RegisterType((*LogCompactedEvent)(nil), "atomix.stores.multiraft.v1.LogCompactedEvent")
	proto.RegisterType((*LogDBCompactedEvent)(nil), "atomix.stores.multiraft.v1.LogDBCompactedEvent")
	proto.RegisterType((*ConnectionEstablishedEvent)(nil), "atomix.stores.multiraft.v1.ConnectionEstablishedEvent")
	proto.RegisterType((*ConnectionFailedEvent)(nil), "atomix.stores.multiraft.v1.ConnectionFailedEvent")
}
...
func (c *nodeClient) Bootstrap(ctx context.Context, in *BootstrapRequest, opts ...grpc.CallOption) (*BootstrapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.stores.multiraft.v1.Node/Bootstrap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeClient) Join(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.stores.multiraft.v1.Node/Join", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeClient) Leave(ctx context.Context, in *LeaveRequest, opts ...grpc.CallOption) (*LeaveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.stores.multiraft.v1.Node/Leave", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeClient) Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (Node_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Node_serviceDesc.Streams[0], "/atomix.stores.multiraft.v1.Node/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
func _Node_Bootstrap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.stores.multiraft.v1.Node/Bootstrap",
	}
...
func _Node_Join_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.stores.multiraft.v1.Node/Join",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Node_Leave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.stores.multiraft.v1.Node/Leave",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Node_serviceDesc = grpc.ServiceDesc{
	ServiceName: "atomix.stores.multiraft.v1.Node",
