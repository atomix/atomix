...
import (
	...
	multiraftapis "github.com/atomix/atomix/stores/multi-raft/pkg/apis"
	multiraftv1beta1 "github.com/atomix/atomix/stores/multi-raft/pkg/controller/multiraft/v1beta1"
...
func getCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:  "atomix-multiraft-controller",
		Args: cobra.NoArgs,
		Run: func(cmd *cobra.Command, args []string) {
			...
			if err := multiraftv1beta1.AddControllers(mgr); err != nil {
				log.Error(err)
				os.Exit(1)
			}
