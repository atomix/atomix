...
/**
 * Default asynchronous map implementation.
 *
 * @author <a href="http://github.com/kuujo">Jordan Halterman</a>
 */
public class DefaultAsyncMap<K, V> extends AbstractResource implements AsyncMap<K, V> {

  public DefaultAsyncMap(String name, Coordinator coordinator, Cluster cluster, CopycatContext context) {
  ...
  public CompletableFuture<Boolean> containsKey(K key) {
    return context.submit(new FluentList().add("contains").add(key), new SubmitOptions().withConsistent(true).withConsistent(false));
  }
  ...
  public CompletableFuture<Void> clear() {
    return context.submit(new FluentList().add("clear"), new SubmitOptions().withConsistent(true).withConsistent(false));
  }
