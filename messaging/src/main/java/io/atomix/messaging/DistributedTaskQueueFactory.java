...
/**
 * Distributed task queue factory.
 *
...
public class DistributedTaskQueueFactory implements ResourceFactory<DistributedTaskQueue<?>> {
  ...
  @Override
  public DistributedTaskQueue<?> createInstance(CopycatClient client, Properties options) {
    return new DistributedTaskQueue<>(client, options);
  }
