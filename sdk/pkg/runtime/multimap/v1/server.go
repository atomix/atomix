...
func newMultiMapServer(delegate *runtime.Delegate[multimapv1.MultiMapServer]) multimapv1.MultiMapServer {
...
type multiMapServer struct {
	delegate *runtime.Delegate[multimapv1.MultiMapServer]
}
