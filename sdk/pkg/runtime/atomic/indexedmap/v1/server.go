...
func newAtomicIndexedMapServer(delegate *runtime.Delegate[indexedmapv1.AtomicIndexedMapServer]) indexedmapv1.AtomicIndexedMapServer {
...
type indexedMapServer struct {
	delegate *runtime.Delegate[indexedmapv1.AtomicIndexedMapServer]
}
...
func (s *indexedMapServer) Events(request *indexedmapv1.EventsRequest, server indexedmapv1.AtomicIndexedMap_EventsServer) error {
	log.Debugw("Events",
...
func (s *indexedMapServer) Entries(request *indexedmapv1.EntriesRequest, server indexedmapv1.AtomicIndexedMap_EntriesServer) error {
	log.Debugw("Entries",
...
var _ indexedmapv1.AtomicIndexedMapServer = (*indexedMapServer)(nil)
