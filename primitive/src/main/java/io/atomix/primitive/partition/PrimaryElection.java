 ...
 * for a partition, a node must call the {@link #enter(Member)} method. Once an election is complete, the
...
public interface PrimaryElection extends ListenerService<PrimaryElectionEvent, PrimaryElectionEventListener> {
   ...
   * <p>
   * When entering a primary election, the provided {@link Member} will be added to the election's candidate list.
