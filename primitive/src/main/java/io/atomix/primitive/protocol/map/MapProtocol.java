 ...
 * Gossip map protocol.
 */
public interface MapProtocol<K, V> {
   ...
   * @return the previous value for the mapping
   */
  V put(K key, V value);
   ...
   * <p>
   * Clients are expected to register an {@link EventListener} if
   * they are interested in receiving notification of updates to the map.
   * </p>
   *
   ...
   * @return a boolean indicating whether the entry was removed
   */
   ...
   * Closes the map.
   *
   * @return a future to be completed once the map has been closed
   */
